...
namespace Nu
{
    ...
    { 
        NU_INLINE ShadowShader(const std::string& path): Shader(path) 
        {
            ...
            { 
                NU_ERROR("CreateDepthBuffer() Failed!"); 
            }
        ...
        NU_INLINE void BeginFrame(const glm::mat4& lightSpaceMtx)
        {
            // bind shadow shader
        ...
        NU_INLINE uint32_t GetDepthMap()
        {
            return m_DepthMap;
        }
