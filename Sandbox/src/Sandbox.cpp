...
public:
	...
	virtual void OnAttach() override
	{
		...
		m_VB = std::unique_ptr<Nu::VertexBuffer>(Nu::VertexBuffer::Create());
		m_VB->SetData(vertices, sizeof(vertices));

		m_IB = std::unique_ptr<Nu::IndexBuffer>(Nu::IndexBuffer::Create());
		m_IB->SetData(indices, sizeof(indices));

		m_Shader.reset(Nu::Shader::Create("assets/shaders/shader.glsl"));
	}
	...
	virtual void OnUpdate() override
	{
		...
		Nu::UniformBufferDeclaration<sizeof(glm::vec4), 1> buffer;
	...
	private:
		std::unique_ptr<Nu::VertexBuffer> m_VB;
		std::unique_ptr<Nu::IndexBuffer> m_IB;
