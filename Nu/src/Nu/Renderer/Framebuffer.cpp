...
#include "Nu/Platform/OpenGL/OpenGLFramebuffer.h"

namespace Nu {

	Nu::Framebuffer* Framebuffer::Create(uint32_t width, uint32_t height, FramebufferFormat format)
	{
		Nu::Framebuffer* result = nullptr;
